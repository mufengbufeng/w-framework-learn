...
public class ui_demo_tips : MonoBehaviour {
	...
	[SerializeField]
	private RectTransform_Button_Image_Set m_btn_toast_2s;
	public RectTransform_Button_Image_Set btn_toast_2s { get { return m_btn_toast_2s; } }

	[SerializeField]
	private RectTransform_Button_Image_Set m_btn_toast_5s;
	public RectTransform_Button_Image_Set btn_toast_5s { get { return m_btn_toast_5s; } }

	[SerializeField]
	private RectTransform_Button_Image_Set m_btn_toast_8s;
	public RectTransform_Button_Image_Set btn_toast_8s { get { return m_btn_toast_8s; } }
	...
	public void Clear() {
		...
		m_btn_toast_2s.button?.onClick.RemoveAllListeners();
		m_btn_toast_5s.button?.onClick.RemoveAllListeners();
		m_btn_toast_8s.button?.onClick.RemoveAllListeners();
		for (int i = 0; i < m_btn_tips.Length; i++) {
			m_btn_tips[i]?.button?.onClick.RemoveAllListeners();
		}
